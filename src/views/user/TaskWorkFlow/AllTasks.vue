    ...
    <div class="category-hero">
      <div class="hero-left">
        <div class="brand-pill">
          ...
          <span class="brand-name">ផ្ទះជួលតាពេជ្រ</span>
        </div>
        <h1 class="hero-title">{{ title }}</h1>
        <p class="hero-sub">បញ្ជីបន្ទប់ជួលទាំងអស់</p>
      </div>
      ...
      <div class="hero-right">
        ...
        <div class="hero-stat">
          <div class="stat-label">ត្រូវបានជួល</div>
...
const props = defineProps({
  title: { type: String, default: "បន្ទប់ជួលទាំងអស់" },
});
